...
export const isFunction = (v: any): v is () => void => typeof v === 'function'
...
export function isModifiedEvent(v: MouseEvent | PointerEvent | KeyboardEvent) {
  return v.ctrlKey || v.altKey || v.metaKey || v.shiftKey
}
