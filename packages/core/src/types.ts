...
export declare namespace StateMachine {
  ...
  export type DelayExpression<TContext extends Dict<any>, TEvent extends EventObject> = Expression<TContext, TEvent, number>
  ...
  export type DelayedTransitions<TContext extends Dict<any>, TState extends StateSchema, TEvent extends EventObject> =
  ...
  export type TransitionDefinitionMap<TContext extends Dict<any>, TState extends StateSchema, TEvent extends EventObject> = {
    [K in TEvent['type']]?:
      | TState['value']
  ...
  export type GuardExpression<TContext extends Dict<any>, TEvent extends EventObject> = Expression<TContext, TEvent, boolean>

  export interface GuardHelper<TContext extends Dict, TEvent extends EventObject> {
  ...
  export interface GuardMap<TContext extends Dict, TEvent extends EventObject> {
  ...
  export interface HookOptions<TContext extends Dict<any>, TState extends StateSchema, TEvent extends EventObject> {
    actions?: ActionMap<TContext, TState, TEvent>
    state?: StateInit<TContext, TState>
    context?: UserContext<TContext>
  }

  export interface Self<TContext extends Dict<any>, TState extends StateSchema, TEvent extends EventObject> {
    id: string
