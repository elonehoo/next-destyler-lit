...
import { cast, isArray, isObject, isString } from '@destyler/utils'
...
export function toTarget<TContext extends Dict<any>, TState extends S.StateSchema, TEvent extends S.EventObject>(
  target: S.Transition<TContext, TState, TEvent>,
): S.TransitionDefinition<TContext, TState, TEvent> {
  return isString(target) ? { target } : target
}

export function determineTransitionFn<TContext extends Dict<any>, TState extends S.StateSchema, TEvent extends S.EventObject>(
...
export function toTransition<TContext extends Dict<any>, TState extends S.StateSchema, TEvent extends S.EventObject>(
